...
class BSBSlider{
	...
	function enqueueBlockAssets(){
		...
		wp_register_script( 'bsb-slider-script', plugins_url( 'dist/script.js', __FILE__ ), [ 'react', 'react-dom', 'jquery', 'bootstrap' ], BSB_PLUGIN_VERSION );
		wp_register_style( 'bsb-slider-style', plugins_url( 'dist/style.css', __FILE__ ), [ 'bootstrap', 'bsbfontawesome' ], BSB_PLUGIN_VERSION ); // Style
	}
