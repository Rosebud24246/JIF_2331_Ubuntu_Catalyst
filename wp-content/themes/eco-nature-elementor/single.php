...
<div class="header-image-box text-center">
  <div class="container">
    ...
    <div class="headerimgbox-meta">
      ...
      <?php endwhile; ?>
      <span class="ml-3"><i class="far fa-comments mr-2"></i> <?php comments_number( esc_attr('0', 'eco-nature-elementor'), esc_attr('0', 'eco-nature-elementor'), esc_attr('%', 'eco-nature-elementor') ); ?> <?php esc_html_e('comments','eco-nature-elementor'); ?></span>
    </div>
